...
class TwoLayerNet(object):
    ...
    def __init__(self, input_dim=3 * 32 * 32, hidden_dim=100, num_classes=10,
        ...
        Inputs:
        - 输入层 input_dim: An integer giving the size of the input
        - 隐层 hidden_dim: An integer giving the size of the hidden layer
    ...
    def loss(self, X, y=None):
        ...
        """
        # print 'loss runing loss runninig111'
        scores = None
        ############################################################################
